...
bg-green-50/20 focus:rounded-full focus:outline-none focus:ring-[1.5px] focus:ring-transparent focus:ring-offset-green-500
focus-visible:ring-offset-2 focus-visible:ring-offset-green-500 dark:border-x-0 dark:border-b-0 dark:border-t-[1px]
dark:border-green-500/40 dark:bg-neutral-900 dark:bg-none dark:focus:ring-offset-green-500
dark:focus-visible:ring-offset-green-500`;
  ...
  return (
    <SectionLayout
      title="Healthcare Solutions That Transform"
      name="Our Services"
      description=" Addressing inefficiencies in patient record management, regulatory
                compliance, and workforce shortages with custom healthcare solutions"
      number={"02"}
      id="services"
      className="pt-32"
    >
      <div className="relative">
        ...
        >
          ...
          >
            <div className="size-fit m-auto relative">
              <div className="relative h-24 w-56 flex items-center">
                <svg
                  className="absolute inset-0 size-full text-caption"
                  viewBox="0 0 254 104"
                  fill="none"
                ...
                <span className="w-fit block mx-auto text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-br from-green-400 to-emerald-700 dark:from-green-300 dark:to-emerald-500">
                  99%
                </span>
              </div>
              <h2 className="mt-6 text-center font-semibold text-3xl text-green-600 group-hover:text-green-700 dark:text-green-400">
          ...
          >
            <div>
              <div className="relative aspect-square rounded-full size-32 flex border mx-auto bg-green-50 dark:bg-emerald-900/30 border-green-200 dark:border-emerald-700 before:absolute before:-inset-2 before:border before:border-green-200 dark:before:border-emerald-700 before:rounded-full">
                <svg
                  className="w-24 m-auto h-fit text-green-600 dark:text-green-400"
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    d="M19.5 22H4.5C4.10218 22 3.72064 21.842 3.43934 21.5607C3.15804 21.2794 3 20.8978 3 20.5V9.5C3 9.10218 3.15804 8.72064 3.43934 8.43934C3.72064 8.15804 4.10218 8 4.5 8H19.5C19.8978 8 20.2794 8.15804 20.5607 8.43934C20.842 8.72064 21 9.10218 21 9.5V20.5C21 20.8978 20.842 21.2794 20.5607 21.5607C20.2794 21.842 19.8978 22 19.5 22Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
              ...
              <div className="mt-6 text-center relative z-10 space-y-2">
                ...
                <p>
                  Complete pharmacy solution with inventory tracking, medicine
                  ordering, and prescription management for efficient pharmacy
                  operations.
                </p>
              </div>
            </div>
          ...
          >
            <div className="grid sm:grid-cols-2">
              <div className="flex flex-col justify-between relative z-10 space-y-12 lg:space-y-6">
                <div className="relative aspect-square rounded-full size-12 flex border border-green-200 dark:bg-white/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full">
                  <svg
                    className="size-6 m-auto text-green-600 dark:text-green-400"
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
                    viewBox="0 0 24 24"
                  >
                    <path
                      fill="currentColor"
                      d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 14v-2.47l6.88-6.88c.2-.2.51-.2.71 0l1.77 1.77c.2.2.2.51 0 .71L8.47 14H6zm11 0h-6.5l2-2H17c.55 0 1 .45 1 1s-.45 1-1 1z"
                    />
                  </svg>
                </div>
                <div className="space-y-2">
                  ...
                  <p className="dark:text-gray-300 text-gray-700">
                    Streamline patient data with secure, centralized records
                    that ensure HIPAA compliance and real-time access for
              ...
              <div
                data-rounded="large"
                className="relative mt-6 sm:mt-auto h-fit -mb-[calc(var(--card-padding)+1px)] -mr-[calc(var(--card-padding)+1px)] sm:ml-6 py-6 p-6 card variant-soft bg-green-50 dark:bg-emerald-900/20"
              >
                <div className="absolute flex gap-1 top-2 left-3">
                  <span className="block size-2 rounded-full bg-green-400"></span>
                  <span className="block size-2 rounded-full bg-green-300"></span>
                  <span className="block size-2 rounded-full bg-green-200"></span>
                </div>
                <svg
                ...
                <div className="relative aspect-square rounded-full size-12 flex border border-green-200 dark:bg-white/5 dark:border-white/10 before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full">
                  ...
                  >
                    <g
                      ...
                      strokeWidth="2"
                    >
                      <path d="M9 12h6m-3-3v6m5.6 3a8 8 0 1 0-11.2 0" />
                      <path d="M9 10V8a3 3 0 0 1 6 0v2a3 3 0 0 1-6 0z" />
                    </g>
                  </svg>
                </div>
                <div className="space-y-2">
                  ...
                  <p className="">
                    Our solutions are built with healthcare regulations in mind,
                    ensuring HIPAA compliance and seamless adaptation to
                    changing healthcare policies.
                  </p>
                </div>
              </div>
              <div className="mt-6 relative sm:-mr-[--card-padding] sm:-my-[--card-padding] before:absolute before:w-px before:inset-0 before:mx-auto before:bg-[--ui-border-color]">
                <div className="relative space-y-6 py-6 flex flex-col justify-center h-full">
                  <div className="flex items-center gap-2 ml-[calc(50%-1rem)] relative">
                    <div className="size-8 ring-4 ring-[--ui-bg] bg-green-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center">
                      <span className="font-bold text-green-700 dark:text-green-300">
                        HIPAA
                      </span>
                    </div>
                    <span className="h-fit text-xs block px-2 py-1 shadow-sm card variant-mixed">
                  ...
                  <div className="flex items-center justify-end gap-2 w-[calc(50%+0.875rem)] relative">
                    ...
                    <div className="size-7 ring-4 ring-[--ui-bg] bg-green-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center">
                      <span className="font-bold text-green-700 dark:text-green-300">
                        GDPR
                      </span>
                    </div>
