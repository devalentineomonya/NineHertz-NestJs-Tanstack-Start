...
import { useAddMedicineService } from "@/services/medicines/use-add-medicine";
...
export const AddMedicineDrawer = () => {
  const { isOpen, onClose } = useAddMedicineStore();
  const addMedicineMutation = useAddMedicineService();
